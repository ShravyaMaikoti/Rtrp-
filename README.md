...
🚀 Key Idea
NetFense works by applying controlled perturbations to graph data (adding/removing edges) to:
...
📌 Conclusion
NetFense provides an effective solution for defending against privacy attacks in GNNs by balancing data security and utility.

output
<img width="1037" height="583" alt="image" src="https://github.com/user-attachments/assets/83acb300-fd58-44a0-b3a0-0560dbd2b92a" />
